                    ...
                    <div>
                        <div className="row f-flex justify-content-around">
                            ...
                            <div className="col-12 col-lg-5 mt-5">
                                ...
                                <button type="button" id="cart_btn" className="btn btn-dark d-inline ml-4" disabled={product.stock === 0} onClick={addToCart}>Add to Cart</button>
                                ...
                                {user ? <button id="review_btn" type="button" className="btn btn-dark mt-4" data-toggle="modal" data-target="#ratingModal" onClick={setUserRatings}>
                                    Submit Your Review
                                </button> :
                                            ...
                                            <div className="modal-dialog" role="document">
                                                <div className="modal-content">
                                                    ...
                                                    <div className="modal-body">
                                                        ...
                                                        <textarea name="review" value={comment} onChange={(e) => setComment(e.target.value)} id="review" className="form-control mt-3">
