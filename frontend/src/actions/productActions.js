...
import { ALL_PRODUCTS_REQUEST, ALL_PRODUCTS_SUCCESS, ALL_PRODUCTS_FAIL, PRODUCT_DETAILS_FAIL, PRODUCT_DETAILS_REQUEST, PRODUCT_DETAILS_SUCCESS,
    ...
    UPDATE_PRODUCT_FAIL, UPDATE_PRODUCT_REQUEST, UPDATE_PRODUCT_RESET, UPDATE_PRODUCT_SUCCESS, CLEAR_ERRORS, GET_REVIEWS_REQUEST, GET_REVIEWS_SUCCESS, GET_REVIEWS_FAIL, DELETE_REVIEW_REQUEST, DELETE_REVIEW_SUCCESS, DELETE_REVIEW_FAIL } from '../constants/productConstants'
...
export const newProduct = (name, price, description, category, stock, seller, images) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post('/api/v1/admin/product/new', {name, price, description, category, stock, seller, images}, config)
...
export const updateProduct = (id, name, price, description, category, stock, seller, images) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`/api/v1/admin/product/${id}`, {name, price, description, category, stock, seller, images}, config)
